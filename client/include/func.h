...
#define MY_LOG_ERROR(logger, format, ...) log_error(logger, __FILE__, __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
#define MY_LOG_WARNING(logger, format, ...) log_message(logger, LOG_LEVEL_WARNING, __FILE__, __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
#define MY_LOG_INFO(logger, format, ...) log_message(logger, LOG_LEVEL_INFO, __FILE__, __FUNCTION__, __LINE__, format, ##__VA_ARGS__)
